(defun color-theme-mummified-monk ()
  "Bill Clementson's white background theme, modified by Simon Zelazny"
  (interactive)
  (color-theme-install
   '(color-theme-mummified-monk
     ...
     (font-lock-function-name-face ((t (:foreground "midnight blue"))))
